...
"""MCP server exposing Phala primitive validators.

Run with ``python -m phala.mcp_server`` or via the ``phala-mcp`` entry
...
from phala.mcp_server.server import build_server, main
